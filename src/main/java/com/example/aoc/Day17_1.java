...
4322674655533
    ...
    public static void main(String[] args) {
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader("input/day17.txt"));
    ...
    private static class Position {
        ...
        public List<Position> getNextValidPositions() {
            ...
            for (int[] dir : dirs) {
                ...
                int newForwardCount = isForwardMove ? this.getForwardCount() + 1 : 1;
                if (hasValidPosition(newRow, newCol, newForwardCount)) {
                    int newHeatLoss = this.getHeatLoss() + map[newRow][newCol];
                    Position newPosition = new Position(newRow, newCol, newHeatLoss, this.getRow(), this.getCol(), newForwardCount, this);
